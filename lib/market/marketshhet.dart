...
import 'package:alevet_market/market/marksetgraph.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(top: 4.h,left: 2.w,right: 2.w,  bottom: 2.h,),
          child: Column(
            ...
            children: [
             Row(
              ...
              InkWell(onTap: () {
                  Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => marketsheetgraph ())
          );
              },
                child: Container(
                  height: 25.h,
                  ...
                  child: Image.asset(
                    'assets/Frame 107.png', // Replace with your image path
